...
public final class SprUtils {
    ...
    public static String getCouleur(ParamList action) {
        return (action == null || action.getCode().equals(CodificationConstant.ACTION_PARAM_ACTIVER)) ? CodificationConstant.COLOR_ACTIVER : CodificationConstant.COLOR_ABANDONNER;
    }
