 ...
 * @author Bouchara
 */
public class GroupeUtilisateurDTO_1 {
    ...
    public GroupeUtilisateurDTO_1() {
    }

    public GroupeUtilisateurDTO_1(String id, String code, String libelle, String description, String idEtat) {
        this.id = id;
        this.code = code;
    ...
    public GroupeUtilisateurDTO_1(String id, String code, String libelle, String description, StatutDTO statutDTO) {
        this.id = id;
        this.code = code;
        this.libelle = libelle;
        this.description = description;
